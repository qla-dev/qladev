            ...
            <div className="ml-10 flex items-baseline space-x-6">
              {navLinks.map((link) => (
                <button
                  ...
                  className="text-gray-300 hover:text-blue-400 hover:shadow-[0_0_10px_rgba(59,130,246,0.5)] px-3 py-2 rounded-md text-sm font-medium font-mono transition-all duration-300"
                >
                  {link.label}
                </button>
              ))}
