...
export const ProgramCard: React.FC<ProgramCardProps> = ({
  ...
  const mentorCards = program.mentors.map((mentor) => {
        ...
        >
          <div className="flex min-w-0 items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-gray-300 font-mono">{mentorTitle}</p>
            </div>
          </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 sm:gap-6">
        ...
        <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
          <div className="min-w-0 order-2 md:flex md:items-center">
            <p className="w-full text-sm leading-relaxed text-gray-300 font-mono">{isBs ? program.descriptionBs : program.description}</p>
          </div>
