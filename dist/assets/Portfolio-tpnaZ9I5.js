import{R as o,j as e,L as m}from"./index-DaR3Coiu.js";import{E as c}from"./external-link-Fr_wWLoJ.js";const p=({t:a})=>{const s=[...o],n=s.findIndex(r=>r.link==="https://crp.ba/");if(n>=0){const[r]=s.splice(n,1);s.splice(2,0,r)}const l=[...s,...s];return e.jsxs("section",{id:"portfolio",className:"py-16 lg:py-24 bg-black relative",children:[e.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-blue-900/20 via-black to-black"}),e.jsx("style",{children:`
